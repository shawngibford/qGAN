...
``requirements.txt`` carries the ``>=`` constraint set; this JSON
...
data + AR; scipy: core/eval helpers; matplotlib: figure suite;
...
PACKAGES: tuple[str, ...] = (
    ...
    # for core/eval.py (statsmodels.tsa.stattools.acf) and was
...
def main() -> None:
    ...
    out = {
        ...
        "note": (
            ...
            "interpreter; requirements.txt carries the >= "
