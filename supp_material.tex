...
\path{revision/results/welch_pairwise.json}, filtered to
\texttt{scale=='OD'}.}
...
\begin{figure}[h]
  ...
  \path{revision/results/figures/preprocessing_pipeline_4panel.json}.}
...
\begin{figure}[h]
  ...
  Source: \path{revision/results/transform_ablation/metrics.csv}.}
