...
budget. Source:
\texttt{revision/results/welch\_pairwise.json}, filtered to
\texttt{scale=='OD'}.}
...
\texttt{revision/results/transform\_ablation/metrics.csv} and
\texttt{summary.md}.
...
\begin{figure}[h]
  ...
  Source: \texttt{revision/results/transform\_ablation/metrics.csv}.}
