...
| LR-DTW VAE (degenerate regime, not posterior collapse — see R1-M1 draft) | 0.088 | `matched2000_dualscale.json` |
| VAE log-return std (matched-budget moment_std) | 0.0186 (vs real ≈ 0.0217) | `matched2000_dualscale.json` |
| VAE log-return lag-1 ACF | −0.648 (vs real −0.064, matched-pipeline reference) | `matched2000_dualscale.json` |
| VAE log-return EMD | 0.016 (lowest of all models — marginal well-aligned) | `matched2000_dualscale.json` |
