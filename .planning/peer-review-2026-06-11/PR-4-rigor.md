...
>
> *VAE and AR(2) are deliberately excluded from this set.* Per the "Pitfall 3" design note at `revision/run_baselines.py:28`, the VAE and AR(2) generators are trained without the $\times 0.1$ post-scaling…
>
...
**Should it?** YES, and the rationale is straightforward to explain. The code change at `revision/run_welch_aggregator.py` lines 138-156 is well-commented internally:
