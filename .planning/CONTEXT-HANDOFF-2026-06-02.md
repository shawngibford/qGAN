...
2. **LR-DTW (NOT LR-EMD) is the surviving quantum-distinguishing signal.** On LR-EMD, every classical adversarial baseline outperforms every quantum variant. Never re-claim quantum advantage on LR-EMD.
