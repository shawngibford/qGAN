...
- **Code location:** `run_matched2000.py:649-748` (VAE + AR(2) training paths)
- **Code reality:**
...
- **2000-epoch matched budget** (main 194-195, 206): matches `run_matched2000.py:168` (`MATCHED_EPOCHS = 2000`) and `core/__init__.py:20` (`NUM_EPOCHS = 2000`). Strict accept gate at `run_matched2000.py:823` enforces this.
...
- **Hyperparameters** (main 197-201): Adam β₁=0.0/β₂=0.9 (`training.py` Adam init), η_G = 6.9173e-5 / η_C = 1.8046e-5 / n_critic = 9 / λ_GP = 2.16 / BS = 12 — all match `core/__init__.py:11-22` exactly.
