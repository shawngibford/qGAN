...
Run: <main-repo>/qgan_env/bin/python -m pytest tests/test_classical.py
or as a plain script:   ... tests/test_classical.py
"""
import torch
...
def test_barrel_imports():
    from core.models import classical, nonadversarial  # noqa: F401
