...
> load sites (inference-only correction via `revision/_wgan_unscale.py`;
...
>
> Authoritative current data: `revision/results/matched2000_dualscale.json`,
> `revision/results/distribution_emd.json`, `revision/results/welch_pairwise.json`,
> `revision/results/lr_dtw_dominance_gap.json`. Audit trail:
...
> `revision/results/matched2000_dualscale.json` LR scale aggregates for
