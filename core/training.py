...
def train_wgan_gp(
    ...
    *,
    ...
    (computed via :func:`core.eval.compute_psd` on log-PSDs).
    ...
    from core import NOISE_LOW, NOISE_HIGH, NUM_QUBITS, BATCH_SIZE, WINDOW_LENGTH
...
# (the noise range constant lives in core/__init__.py as NOISE_HIGH;
