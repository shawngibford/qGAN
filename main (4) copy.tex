...
\paragraph{Discriminative-score uniformity (evaluation-protocol note).}
...
models and are reported in the supplementary figure suite alongside the
per-model TimeGAN scores.
...
VAE$=0.0158$. Every classical adversarial baseline ($0.0071$--$0.0127$)
outperforms every quantum variant ($0.0143$--$0.0150$) on LR-EMD, and
AR(2) leads at $0.0029$ --- roughly five times lower than the quantum
cluster. We disclose this asymmetry rather than report it as a
