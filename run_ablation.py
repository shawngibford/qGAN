...
Per CONTEXT.md decisions:
    ...
    D-09.1-16 — reuses ``core.training.train_wgan_gp``; no duplicated
                training logic.
...
Usage
-----
    python -m run_ablation --pipeline {A|B|C} --seed N \\
        [--epochs 1000] [--out-root results/transform_ablation] \\
        [--csv-path ./data.csv]
...
def main() -> None:
    ...
    #    core/__init__.py constants (D-09.1-04 identical-conditions).
    config: Dict[str, Any] = {
